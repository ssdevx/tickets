...
var SubCategoryModel = /** @class */ (function () {
    function SubCategoryModel() {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, index_model_1.query(sql)];
                        case 1: return [2 /*return*/, _b.sent()];
                        case 2:
                            _a = multipleColumnSet(params), columnSet = _a.columnSet, values = _a.values;
                            sql += " WHERE " + columnSet;
                            return [4 /*yield*/, index_model_1.query(sql, __spreadArrays(values))];
        ...
        this.create = function (_a) {
            var _b = _a.id_categoria, id_categoria = _b === void 0 ? 0 : _b, _c = _a.nombre, nombre = _c === void 0 ? '' : _c, _d = _a.activo, activo = _d === void 0 ? 1 : _d;
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, index_model_1.query(sql, [id_categoria, nombre, activo])];
                        case 1:
                            result = _e.sent();
                            filasAfectadas = result ? result.affectedRows : 0;
        ...
        this.update = function (params, id) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = multipleColumnSet(params), columnSet = _a.columnSet, values = _a.values;
                        sql = "UPDATE " + this.tabla + " SET " + columnSet + " WHERE id_sucursal = ?";
                        return [4 /*yield*/, index_model_1.query(sql, __spreadArrays(values, [id]))];
                    case 1:
                        result = _b.sent();
        ...
        this.delete = function (id) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        sql = "UPDATE " + this.tabla + " SET activo = 0 WHERE id_sucursal = ?";
                        return [4 /*yield*/, index_model_1.query(sql, [id])];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result];
                }
